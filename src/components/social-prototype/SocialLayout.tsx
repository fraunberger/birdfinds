      ...
      <div className="max-w-2xl mx-auto p-3 sm:p-6 min-h-screen flex flex-col">
        <header className="flex items-center justify-between mb-4 sm:mb-8 border-b border-neutral-300 pb-3 sm:pb-4">
          <div className="flex items-center gap-4">
            ...
            <Link href="/apps" className="text-[10px] uppercase tracking-widest text-neutral-400 hover:text-neutral-700">
              Apps
            </Link>
          </div>
        ...
        <main className="flex-grow">
          <FeatureWalkthrough isSignedIn={Boolean(user)} />

          {user && needsOnboarding ? (
            <div className="mb-4 border border-amber-200 bg-amber-50 px-3 py-2 text-[10px] uppercase tracking-widest text-amber-700">
              Finish profile setup in <Link href="/settings" className="underline">settings</Link>.
            </div>
          ) : null}
